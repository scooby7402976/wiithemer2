...
function show_main_img(imgnum, index_needed) {
    ...
    switch (imgnum) {
        case 1:
            document.getElementById("imgcontainer").innerHTML = "<span title='Close Window' onclick='close_main_img()'>&times</span><img id='largeimg' alt='largeimage1' src='resources/home/luigiv2.avif'></img>";
            break;
        case 2:
            document.getElementById("imgcontainer").innerHTML = "<span title='Close Window' onclick='close_main_img()'>&times</span><img id='largeimg' alt='largeimage2' src='resources/home/darkwii.avif'></img>";
            break;
        case 3:
            document.getElementById("imgcontainer").innerHTML = "<span title='Close Window' onclick='close_main_img()'>&times</span><img id='largeimg' alt='largeimage3' src='resources/home/windowsxp.avif'></img>"; 
            break;
        case 4:
            document.getElementById("imgcontainer").innerHTML = "<span title='Close Window' onclick='close_main_img()'>&times</span><img id='largeimg' alt='largeimage4' src='" + main_img_str + "'></img>"; 
            break;
        case 5:
            document.getElementById("imgcontainer").innerHTML = "<span title='Close Window' onclick='close_main_img()'>&times</span><img id='largeimg' alt='largeimage5' src='" + secondary_img_str + "'></img>"; 
            break;
        default:
            break;
    }
...
function link_nav(nav_input) {
    ...
    switch (nav_input) {
        case 1:
            document.getElementById("tabcontent").innerHTML = "<div id='linknavcont'><div id='link_tab' onclick='link_nav(1)'>Links</div><div id='stat_tab' onclick='link_nav(2)'>Stats Tab</div></div><hr></hr><p><a target='blank' href='https://gbatemp.net'>GBAtemp</a> &gt;&gt;&gt; The best gaming community .</p>"
            ...
            break;
        case 2:
             document.getElementById("tabcontent").innerHTML = "<div id='linknavcont'><div id='link_tab' onclick='link_nav(1)'>Links</div><div id='stat_tab' onclick='link_nav(2)'>Stats Tab</div></div><hr></hr><p>Current Total Themes Available: " + theme_count + "</p>";
...
function pagenav(nav_input) {
    ...
    switch (nav_input) {
        case 1:
            document.getElementById("tabcontent").innerHTML = "<h1>Build and Download Wii System Menu Themes</h1><hr></hr><img title='Click to enlarge image.' id='img1' alt='image1' src='resources/home/luigiv2.avif' onclick='show_main_img(1,0)'></img><img title='Click to enlarge image.' id='img2' alt='image2' src='resources/home/darkwii.avif' onclick='show_main_img(2,0)'></img><img title='Click to enlarge image.' id='img3' alt='image3' src='resources/home/windowsxp.avif' onclick='show_main_img(3,0)'></img><br></br><p style='text-align:center'>Welcome to the Wii System Menu Theme Building Home page!</p><br></br><br></br><p>Here, you can build and download custom themes for your Wii System Menu. Explore our collection of themes and enhance your Wii experience! These are just a few examples of the 299 themes available. More Themes Coming Soon.....</p>";
            document.getElementById("tab1").style.backgroundColor = "#ff800f";
			document.getElementById("tab1").style.color = "#ffffff";
			document.getElementById("tab1").style.borderColor = "#ffff00";
            break;
        case 2:
            document.getElementById("tabcontent").innerHTML = "<h1>Instructions</h1><p>Here are the instructions to build and download Wii System Menu Themes.</p>";
            document.getElementById("tab2").style.backgroundColor = "#ff800f";
			document.getElementById("tab2").style.color = "#ffffff";
			document.getElementById("tab2").style.borderColor = "#ffff00";
            break;
        case 3:
            ...
            document.getElementById("tab3").style.backgroundColor = "#ff800f";
			document.getElementById("tab3").style.color = "#ffffff";
			document.getElementById("tab3").style.borderColor = "#ffff00";
            break;
        case 4:
            document.getElementById("tabcontent").innerHTML = "<p style='text-align:center'>Browse through our gallery of Wii System Menu Themes and Videos.</p><hr></hr><select id='preview_select' name='preview_select'></select><button id='loadpreviewbtn' onclick='show_preview_container()'>View Theme</button>";
            //document.getElementById("previewcontainer").style.display = "block";
			load_preview_theme_list();
			document.getElementById("tab4").style.backgroundColor = "#ff800f";
			document.getElementById("tab4").style.color = "#ffffff";
			document.getElementById("tab4").style.borderColor = "#ffff00";
			break;
        case 5:
            document.getElementById("tabcontent").innerHTML = "<div id='linknavcont'><div id='link_tab' onclick='link_nav(1)'>Links</div><div id='stat_tab' onclick='link_nav(2)'>Stats Tab</div></div><hr></hr>";
            document.getElementById("tab5").style.backgroundColor = "#ff800f";
			document.getElementById("tab5").style.color = "#ffffff";
			document.getElementById("tab5").style.borderColor = "#ffff00";
            if (links_tab_active) {
                document.getElementById("link_tab").style.backgroundColor ="#ff800f";
                document.getElementById("link_tab").style.color = "#ffffff";
                document.getElementById("link_tab").style.borderColor = "#ffff00";
        ...
        case 6:
            ...
            document.getElementById("tab6").style.backgroundColor = "#ff800f";
			document.getElementById("tab6").style.color = "#ffffff";
			document.getElementById("tab6").style.borderColor = "#ffff00";
            break;
        default:
...
function load_preview_theme_list() {
    console.log("Loading preview theme list...");
    $('#preview_select').empty();   
    console.log("Total themes: " + theme_count);
    for (let i = 0; i < theme_count; i++) {
        const theme = completethemeinfo[i];
...
function show_preview_container() {
    ...
    previewHTML += "<img id='preview_secondaryimg' alt='preview_secondaryimg' src='resources/theme_secondary/" + theme.secondaryimg + "' width='450' height='275' onclick='show_main_img(5,1)'></img></div>";
...
function show_download_name(installer_num) {
    switch (installer_num) {
        case 1:
            document.getElementById("installer_name").innerText = "Download MyMenuifyMod Theme Installer (Wii/vWii)";
            break;
        case 2:
            document.getElementById("installer_name").innerText = "Download WiiThemer Theme Installer (Wii Only)";
            break;
        case 3:
            document.getElementById("installer_name").innerText = "Download Csm-Installer Theme Installer (Wii/vWii)";
            break;
        default:
            break;
    }
